...
public class SystemOptionDaoImpl implements SystemOptionDao {
    ...
    @Override
    public void saveAllSystemOptionData(List<SystemOption> systemOptions) throws SaveSystemOptionsDataException {
        securityEndpoint.saveSystemOptionsData(systemOptions);
    }
}
